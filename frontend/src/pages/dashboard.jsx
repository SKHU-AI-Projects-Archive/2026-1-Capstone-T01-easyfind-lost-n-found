    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#f0f2f5' }}>
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={{ width: '200px', background: 'white', borderRight: '1px solid #e5e7eb', display: 'flex', flexDirection: 'column', padding: '12px 0' }}>
          {['Monitoring', 'Detection History', 'Alerts', 'Settings'].map((item, i) => (
            <div key={i} style={{
              padding: '10px 20px',
              fontSize: '13px',
              color: i === 0 ? '#1a1f2e' : '#6b7280',
              fontWeight: i === 0 ? '600' : '400',
              background: i === 0 ? '#f0f2f5' : 'transparent',
              cursor: 'pointer',
            }}>{item}</div>
          ))}
          <div style={{ marginTop: 'auto', padding: '12px 20px', fontSize: '11px', color: '#9ca3af' }}>
            <div>Camera 4 / 4 connected</div>
            <div style={{ marginTop: '4px' }}>YOLOv8 + ByteTrack</div>
          </div>
        </div>
        ...
        {/* Right Panel */}
        <div style={{ width: '260px', background: 'white', borderLeft: '1px solid #e5e7eb', padding: '16px', display: 'flex', flexDirection: 'column', gap: '16px', overflow: 'auto' }}>
          <div>
