      ...
      <div style={{ background: 'white', border: '1px solid #e5e7eb', borderRadius: '10px', padding: '16px 20px', marginBottom: '16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px' }}>
          {[
            ...
            { label: 'Camera', options: ['All Cameras', 'CAM-A2', 'CAM-B1', 'CAM-C4', 'CAM-D3'] },
            { label: 'Object Type', options: ['All Types', 'Backpack', 'Luggage', 'Handbag', 'Coat'] },
            { label: 'Status', options: ['All Status', 'Suspected', 'Confirmed'] },
          ].map((filter, i) => (
            <div key={i}>
              <div style={{ fontSize: '12px', color: '#6b7280', marginBottom: '6px' }}>{filter.label}</div>
              <select style={{ width: '100%', padding: '8px 12px', border: '1px solid #e5e7eb', borderRadius: '8px', fontSize: '13px', color: '#1a1f2e' }}>
